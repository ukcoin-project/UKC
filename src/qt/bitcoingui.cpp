    ...
    prevBlocks(0)
{
    ...
    {
        setWindowTitle(tr("UKCoin") + " - " + tr("") + " " + tr("[testnet]"));
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send UKCoin"), this);
    ...
    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive UKCoin"), this);
    ...
    if (!fIsTestnet)
        ...
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About UKCoin"), this);
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    {
        trayIcon->setToolTip(tr("UKCoin client") + " " + tr("[testnet]"));
