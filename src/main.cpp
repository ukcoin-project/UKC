...
// Copyright (c) 2013 UKCoin developers
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	if(nHeight < 101) {nSubsidy = 150000000 * COIN;} //50% Premine for the UK Citizens
	else if(nHeight < 100001) {nSubsidy = nStartSubsidy * 4;} //4x Rewards for the first 100K Blocks
	else if(nHeight < 150001) {nSubsidy = nStartSubsidy * 2;} //2x Rewards for the next 50K Blocks
	nSubsidy >>= (nHeight / Params().SubsidyHalvingInterval()); //Halving at 500K blocks
...
{
		 int DiffMode = 1;
		 if (pindexLast->nHeight+1 >= 10000) { DiffMode = 2; }
